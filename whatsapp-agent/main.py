...
Compatible con:
  ...
  - Meta WhatsApp Cloud API (para producción con número real)
"""
...
async def webhook_twilio(
    ...
    """
    Twilio envía los datos del mensaje como form-data.
...
# ─────────────────────────────────────────────
#  META WEBHOOK  (para producción con número real)
# ─────────────────────────────────────────────
...
async def webhook_meta(request: Request):
    """
    Meta envía los mensajes entrantes como JSON.
    """
